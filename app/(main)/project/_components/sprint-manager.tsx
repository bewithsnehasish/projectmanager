...
interface Sprint {
  ...
  // Add other sprint properties as needed
}
...
interface UpdateSprintStatusResponse {
  success: boolean;
  sprint: Sprint;
}
...
export default function SprintManager({
  ...
  const {
    ...
    loading,
    data: updatedStatus,
  } = useFetch<UpdateSprintStatusResponse, [string, Sprint["status"]]>(
    async (sprintId: string, newStatus: Sprint["status"]) =>
